...
## Writeup
  ...
  Đầu bài yêu cầu ta nhập tên để có **flag**,ta sử dụng ida để xem pseudo code    
  ![image](https://github.com/user-attachments/assets/8c7d2db1-dcff-4456-a7d2-8fc06140dc74)  
  Ở đây, ta có thể thấy câu lệnh **read(0, &buffer, 0x200uLL)** cho phép ta nhập 512 ký tự. Đây dạng bài **ret2win**, nhiệm vụ của ta là thay đổi giá trị của a thành *0xdeadbeef* 
  ...
  Điều bất thường là sau khi ta chạy file thì chương trình lại không trả về bất cứ giá trị gì nên ta thử thay `p.recvline()` bằng `p.interactive()`  
  ...
  **Flag:** `PTITCTF{fl0w_fl0w_0v3rfl0w_g3t_w1n}`
